...
export default function Profile() {
  ...
  const logout = async () => {
    try {
      ...
      // Close any open modals immediately so navigation isn't visually blocked.
      setShowDeleteModal(false);
      setShowThemeModal(false);

      // Clear session optimistically (updates UI immediately).
      // Do NOT await: Supabase signOut can take time and we want instant redirect.
      void clearSession();
